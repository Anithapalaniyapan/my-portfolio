  ...
  const projects = [
    {
      ...
      description: "A responsive admin dashboard for an e-commerce platform with sales analytics, inventory management, and customer insights. Features dark/light mode and interactive charts.",
      ...
      technologies: ["React", "Material UI", "Chart.js", "Redux", "Styled Components"],
      liveLink: "https://ecommerce-dashboard-demo.netlify.app",
      codeLink: "https://github.com/anithapalaniyappan/ecommerce-dashboard",
    },
    {
      id: 2,
      title: "Weather Forecast App",
      description: "A sleek weather application that displays current conditions and 5-day forecasts for any location. Features include geolocation, animated weather icons, and temperature unit conversion.",
      image: "/project-weather-app.jpg",
      fallbackImage: `data:image/svg+xml,%3Csvg width='350' height='200' viewBox='0 0 350 200' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='350' height='200' fill='%23e0f2f2' /%3E%3Crect x='50' y='30' width='250' height='30' rx='5' fill='%23008080' /%3E%3Crect x='50' y='80' width='100' height='80' rx='5' fill='%23008080' /%3E%3Crect x='170' y='80' width='130' height='30' rx='5' fill='%23008080' /%3E%3Crect x='170' y='130' width='130' height='30' rx='5' fill='%23008080' /%3E%3C/svg%3E`,
      technologies: ["React", "OpenWeather API", "CSS Modules", "Framer Motion"],
      liveLink: "https://weather-forecast-demo.netlify.app",
      codeLink: "https://github.com/anithapalaniyappan/weather-app",
    },
    {
      id: 3,
      title: "Task Management App",
      description: "A modern task management application with drag-and-drop functionality, task categorization, and deadline tracking. Includes user authentication and data persistence.",
      ...
      codeLink: "https://github.com/anithapalaniyappan/task-manager",
    },
    {
      id: 4,
